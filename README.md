...
| **gstack** | Garry Tan's personal Claude Code setup: ~23 opinionated slash-command skills that role-play a virtual engineering team (CEO review, designer, eng-manager, QA, security officer) across a plan-build-review-ship-retro loop. | MIT | B (4/6) | [EN](categories/agent-skills/personal-collections/engineering-workflows/gstack.md) · [中](categories/agent-skills/personal-collections/engineering-workflows/gstack.zh.md) |
...
| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **FFmpeg** | Use it when you must decode/encode/transcode/filter virtually any audio or video in a pipeline — mind the LGPL→GPL build trap. | LGPL-2.1-or-later | A (3/6) | [EN](categories/media-processing/video-audio/transcoding-and-pipelines/ffmpeg.md) · [中](categories/media-processing/video-audio/transcoding-and-pipelines/ffmpeg.zh.md) |
| **HandBrake** | Use it when you need a preset-driven GUI or CLI to rip/transcode video to modern MP4/MKV with H.264/H.265 — but it's an end-user app, not a library, and far narrower than raw FFmpeg. | GPL-2.0-or-later | A (4/6) | [EN](categories/media-processing/video-audio/transcoding-and-pipelines/handbrake.md) · [中](categories/media-processing/video-audio/transcoding-and-pipelines/handbrake.zh.md) |
...
| **MoviePy** | Use it when you want a friendly Python API for programmatic video editing — cutting, compositing, text, effects — but it's batch-only, slower than raw FFmpeg for large files, and maintenance has slowed from its peak. | MIT | B (5/6) | [EN](categories/media-processing/video-audio/editing-and-cutting/moviepy.md) · [中](categories/media-processing/video-audio/editing-and-cutting/moviepy.zh.md) |
| **Auto-Editor** | Use it when the first pass is mechanical — cut silence by loudness (or cut by the spoken words) in one command, then render a trimmed file or export an importable Premiere / Resolve / Final Cut timeline — but it's a UI-less CLI from one maintainer whose PyPI channel is retired. | Unlicense | B (6/6) | [EN](categories/media-processing/video-audio/editing-and-cutting/auto-editor.md) · [中](categories/media-processing/video-audio/editing-and-cutting/auto-editor.zh.md) |
...
| **MLT** | Use it when you're building a custom video editor or automated editing pipeline that needs a timeline model — but it's a framework, not a ready-to-use NLE, and delegates all codec work to FFmpeg. | LGPL-2.1-or-later | B (5/6) | [EN](categories/media-processing/video-audio/editing-and-cutting/mlt.md) · [中](categories/media-processing/video-audio/editing-and-cutting/mlt.zh.md) |
| **OpenAI Whisper** | Use it when you need general-purpose multilingual speech-to-text transcription or translation to English from audio/video files — but it's not real-time by default, large models are slow on CPU, and it hallucinates on non-speech content. | MIT | B (5/6) | [EN](categories/media-processing/video-audio/speech-and-subtitles/whisper.md) · [中](categories/media-processing/video-audio/speech-and-subtitles/whisper.zh.md) |
...
| **Jianying Editor Skill** | Use it when an agent should assemble an editable 剪映 Pro timeline from natural language — B-roll, TTS narration, aligned captions, effects — but it's an eight-month-old single-maintainer skill on a vendored fork, and unattended export needs Windows with 剪映 5.9 or older. | MIT | C (5/6) | [EN](categories/media-processing/nle-automation/jianying-editor-skill.md) · [中](categories/media-processing/nle-automation/jianying-editor-skill.zh.md) |
...
| **video-shotcraft** | Use it when a coding agent should turn your product's real screenshots into a 30–60 s cinematic promo — ~157 shot recipe cards, a validated 36-second template, SFX/BGM and a post-delivery workbench, Apache-2.0 — but the pack is two months old and Remotion's own licence carries a company-size threshold. | Apache-2.0 | B (4/6) | [EN](categories/video-production/video-shotcraft.md) · [中](categories/video-production/video-shotcraft.zh.md) |
| **claude-video** | Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude. | MIT | C (4/6) | [EN](categories/media-processing/video-audio/speech-and-subtitles/claude-video.md) · [中](categories/media-processing/video-audio/speech-and-subtitles/claude-video.zh.md) |
