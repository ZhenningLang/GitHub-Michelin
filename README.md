...
| **OpenClaw** | A personal AI assistant that runs on your own devices and answers you across 20+ messaging channels — but it's extremely young with no Lindy track record. | MIT | B (5/6) | [EN](categories/agent-frameworks/agent-runtimes/openclaw.md) · [中](categories/agent-frameworks/agent-runtimes/openclaw.zh.md) |
...
| **AutoGPT** | A platform to create, deploy, and manage continuous AI agents that automate complex workflows — but it has no declared license and requires significant resources to self-host. | NOASSERTION | A (5/6) | [EN](categories/agent-frameworks/workflow-builders/autogpt.md) · [中](categories/agent-frameworks/workflow-builders/autogpt.zh.md) |
...
| **Memori** | Use it when you want LLM-agnostic persistent agent memory captured by wrapping your existing client. | Apache-2.0 | B (6/6) | [EN](categories/agent-memory/memori.md) · [中](categories/agent-memory/memori.zh.md) |
...
| **React Doctor** | Use it when a coding agent writes React and you want deterministic, repeatable checks for React-specific anti-patterns. | LicenseRef-Modified-MIT | B (6/6) | [EN](categories/ai-code-review/react-doctor.md) · [中](categories/ai-code-review/react-doctor.zh.md) |
...
| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **12-Factor Agents** | Use it when you want production-agent design principles to guide a hand-rolled or thinly-framed agent. | CC-BY-SA-4.0 (content) / Apache-2.0 (code examples) | B (4/6) | [EN](categories/agent-dev-methodology/spec-driven-development/12-factor-agents.md) · [中](categories/agent-dev-methodology/spec-driven-development/12-factor-agents.zh.md) |
...
| **OpenZL** | Use it when you must squeeze terabytes of one highly structured/numeric format better than generic zstd. | BSD-3-Clause | B (5/6) | [EN](categories/dev-utilities/data-tools/openzl.md) · [中](categories/dev-utilities/data-tools/openzl.zh.md) |
...
| **Zed** | A high-performance, native code editor with real-time multiplayer collaboration from the creators of Atom — but far smaller extension ecosystem than VS Code and only ~4 years old. | NOASSERTION | A (5/6) | [EN](categories/dev-utilities/editors-and-runtimes/zed.md) · [中](categories/dev-utilities/editors-and-runtimes/zed.zh.md) |
...
| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **HiveChat** | Self-hostable, admin-managed AI chat for small/medium teams: one admin wires many LLM providers; the team chats with per-group model access and token quotas. | Apache-2.0 | B (4/6) | [EN](categories/team-chat/hivechat.md) · [中](categories/team-chat/hivechat.zh.md) |

### captcha

| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **Cap** | Lightweight self-hosted CAPTCHA alternative: an invisible proof-of-work challenge (SHA-256 nonce in a Rust→WASM worker) issuing a server-verifiable token — no images, no third-party calls. | Apache-2.0 | B (6/6) | [EN](categories/captcha/capjs.md) · [中](categories/captcha/capjs.zh.md) |
...
| **TaskMatrix** | Use it only to study an early visual-tool-routing agent (Visual ChatGPT) — abandoned since ~2024, don't build on it. | MIT | D (3/6) | [EN](categories/ml-research/taskmatrix.md) · [中](categories/ml-research/taskmatrix.zh.md) |
...
| **huashu-skills** | 花叔的内容创作 Skills 合集 - AI审校、选题生成、视频大纲、素材搜索等 11 个实用技能 | NOASSERTION | D (4/6) | [EN](categories/agent-skills/writing/huashu-skills.md) · [中](categories/agent-skills/writing/huashu-skills.zh.md) |
...
| **writing-agent** | 🚀 一个基于 Claude Code (Skills + Subagents) 的“去AI味”全栈写作系统。不仅防套路，更通过专属规则强制注入人类观点与细节，搭配读者测试评估与自动图文排版。全面支持 DeepSeek / 智谱GLM / MiniMax 等国产低成本大模型，提供从选题、风格建模到审稿发布的高维全自动写作工作流。 | MIT | B (4/6) | [EN](categories/agent-skills/writing/writing-agent.md) · [中](categories/agent-skills/writing/writing-agent.zh.md) |
...
| **caveman** | Prompt and installer pack that makes many coding agents answer in deliberately terse "caveman" style while preserving code, commands, and errors. | MIT | B (4/6) | [EN](categories/agent-skills/engineering/caveman.md) · [中](categories/agent-skills/engineering/caveman.zh.md) |
| **open-seo** | Open source alternative to Semrush and Ahrefs | MIT | B (5/6) | [EN](categories/agent-skills/writing/open-seo.md) · [中](categories/agent-skills/writing/open-seo.zh.md) |
...
| **marketingskills** | Marketing skills for Claude Code and AI agents. CRO, copywriting, SEO, analytics, and growth engineering. | MIT | B (4/6) | [EN](categories/agent-skills/writing/marketingskills.md) · [中](categories/agent-skills/writing/marketingskills.zh.md) |
...
| **bpmn-js** | Use it when business analysts must author or view standards-correct BPMN 2.0 diagrams inside your web app — but its license mandates a non-removable bpmn.io watermark, so confirm terms before white-labeling. | MIT + bpmn.io watermark clause | A (6/6) | [EN](categories/diagramming/bpmn-js.md) · [中](categories/diagramming/bpmn-js.zh.md) |
...
| **you-get** | Use it when you want a tiny Python CLI to grab video/audio from YouTube and many Chinese sites (Bilibili/Youku) — lighter than yt-dlp. | MIT | C (4/6) | [EN](categories/media-download/you-get.md) · [中](categories/media-download/you-get.zh.md) |
...
| **VMAF** | Use it when you're tuning an encoding ladder and need a perceptual 0-100 score to compare codecs/presets the way the industry does — but it's full-reference only, and picking the wrong model silently invalidates cross-version comparisons. | BSD-2-Clause-Patent | B (6/6) | [EN](categories/media-processing/quality-metrics/vmaf.md) · [中](categories/media-processing/quality-metrics/vmaf.zh.md) |
...
| **Hypit** | Use it when your agent should clone a specific viral video into an editable, word-anchored SVML workflow and ship batch variants by swapping face/words/B-roll — agent-first, non-OSI license, very young. | Hypit Open Source License (modified Apache-2.0, non-OSI) | B (4/6) | [EN](categories/video-production/hypit.md) · [中](categories/video-production/hypit.zh.md) |
...
| **Open WebUI** | A self-hosted AI chat platform with built-in RAG, Ollama support, and offline operation — but it's single-user-shaped by default. | NOASSERTION | B (6/6) | [EN](categories/llm-chat-ui/open-webui.md) · [中](categories/llm-chat-ui/open-webui.zh.md) |
...
| **marked** | Use it when you need a fast, low-level Markdown→HTML parser in JS — but you must sanitize the output yourself and don't need strict CommonMark. | MIT | A (6/6) | [EN](categories/markdown-tools/marked.md) · [中](categories/markdown-tools/marked.zh.md) |
...
| Project | Use when | License | Health | Page |
| --- | --- | --- | --- | --- |
| **Modular Platform (MAX + Mojo)** | Use it when you want a high-performance GPU/CPU inference platform (MAX) plus the Mojo systems language — accepting single-vendor lock-in and partly non-production licensing. | Apache-2.0 (mixed) | B (6/6) | [EN](categories/llm-inference/modular.md) · [中](categories/llm-inference/modular.zh.md) |
...
| **TensorRT-LLM** | Use it when you need maximum LLM inference throughput on NVIDIA GPUs and are willing to accept NVIDIA-only lock-in, complex build/engine-compile workflow, and closed-source kernels. | Apache-2.0 | B (5/6) | [EN](categories/llm-inference/tensorrt-llm.md) · [中](categories/llm-inference/tensorrt-llm.zh.md) |
...
| **Astro** | The web framework for content-driven websites. ⭐️ Star to support our work! | NOASSERTION | A (6/6) | [EN](categories/web-ui/frameworks/astro.md) · [中](categories/web-ui/frameworks/astro.zh.md) |
