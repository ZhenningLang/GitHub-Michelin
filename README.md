...
| **Wechaty** | The reusable multi-language framework behind many personal-account bots: own the adapter and command layer yourself, and check each provider before betting on a channel. | Apache-2.0 | C (5/6) | [EN](categories/im-automation/wechaty.md) · [中](categories/im-automation/wechaty.zh.md) |
| **CowAgent** | Python-first multi-channel assistant with pluggable model backends; the renamed `zhayujie/chatgpt-on-wechat` lineage, now on an iLink channel instead of the deleted personal-account path. | MIT | A (5/6) | [EN](categories/im-automation/cowagent.md) · [中](categories/im-automation/cowagent.zh.md) |
| **WeChatFerry** | Do not deploy: the maintainer archived it, releases are pinned to an old Windows WeChat build, and the approach is client injection. | MIT | D (5/6) | [EN](categories/im-automation/wechatferry.md) · [中](categories/im-automation/wechatferry.zh.md) |
| **Dify on WeChat** | A source-inspectable Dify-to-WeChat bridge — with no code change since 2025-04 and personal-account channel risk still attached. | MIT | B (3/6) | [EN](categories/im-automation/dify-on-wechat.md) · [中](categories/im-automation/dify-on-wechat.zh.md) |
