...
| **Symphony** | Your Linear backlog and Codex agent need a self-hosted orchestrator running isolated per-issue autonomous implementation runs. | Apache-2.0 | C (5/6) | [EN](categories/agent-frameworks/agent-runtimes/symphony.md) · [中](categories/agent-frameworks/agent-runtimes/symphony.zh.md) |
...
| **OpenClaw** | A personal AI assistant that runs on your own devices and answers you across 20+ messaging channels — but it's extremely young with no Lindy track record. | MIT | B (4/6) | [EN](categories/agent-frameworks/agent-runtimes/openclaw.md) · [中](categories/agent-frameworks/agent-runtimes/openclaw.zh.md) |
| **OpenHuman** | A local-first personal AI assistant that ingests your mail, calendar and repos into Markdown memory on a 20-minute loop and can be forced offline in its Rust core — but it's 7 months old, one author holds most commits, and it's GPL-3.0-only. | GPL-3.0-only | B (5/6) | [EN](categories/agent-frameworks/agent-runtimes/openhuman.md) · [中](categories/agent-frameworks/agent-runtimes/openhuman.zh.md) |
...
| **Hermes Agent** | The self-improving AI agent built by Nous Research with a learning loop — but it's under a year old and the learning-loop stability is unproven. | MIT | B (5/6) | [EN](categories/agent-frameworks/agent-runtimes/hermes-agent.md) · [中](categories/agent-frameworks/agent-runtimes/hermes-agent.zh.md) |
...
| **CrewAI** | Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks. | MIT | A (6/6) | [EN](categories/agent-frameworks/agent-runtimes/crewai.md) · [中](categories/agent-frameworks/agent-runtimes/crewai.zh.md) |
| **LangGraph** | Build resilient agents. | MIT | A (6/6) | [EN](categories/agent-frameworks/agent-runtimes/langgraph.md) · [中](categories/agent-frameworks/agent-runtimes/langgraph.zh.md) |
...
| **AutoGen** | A programming framework for agentic AI | CC-BY-4.0 | C (6/6) | [EN](categories/agent-frameworks/agent-runtimes/autogen.md) · [中](categories/agent-frameworks/agent-runtimes/autogen.zh.md) |
| **Pydantic AI** | AI Agent Framework, the Pydantic way | MIT | A (5/6) | [EN](categories/agent-frameworks/agent-runtimes/pydantic-ai.md) · [中](categories/agent-frameworks/agent-runtimes/pydantic-ai.zh.md) |
| **OpenAI Agents SDK** | A lightweight, powerful framework for multi-agent workflows | MIT | A (6/6) | [EN](categories/agent-frameworks/agent-runtimes/openai-agents-sdk.md) · [中](categories/agent-frameworks/agent-runtimes/openai-agents-sdk.zh.md) |
| **eve** | Your agent must wait days for a human or a webhook, survive redeploys, and answer on Slack/Discord/Teams — as one deployable TypeScript service. | Apache-2.0 | A (6/6) | [EN](categories/agent-frameworks/agent-runtimes/eve.md) · [中](categories/agent-frameworks/agent-runtimes/eve.zh.md) |
