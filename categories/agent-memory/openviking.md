...
- **Adoption & ecosystem — real and measurable, not just stars.** 38.2k stars / 3.0k forks (API-verified 2026-09-22), 449,975 PyPI downloads in the last measured month (2026-09-21), SDKs in three languages, and out-of-the-box integrations for ten harnesses plus MCP, LangChain and a portable "Agent Plugins 1.0" bundle. The measured package-graph tier is empty (0 dependent repos), so ecosystem consumption is still mostly direct installs `[推断]`.
