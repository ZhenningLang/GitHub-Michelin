...
- **维护活跃度——非常活跃（截至 2026-09-20）。** `pushed_at` 为 2026-09-20T04:23:59Z，最新版本 v2.6.1 发布于 2026-09-18，minor 大约按月推进（v2.5.0 在 2026-08-04，v2.6.0 在 2026-09-08）。抽样的 issue 列表显示当天或次日关闭。未归档。
