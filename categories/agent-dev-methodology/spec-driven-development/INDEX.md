...
| --- | --- | --- | --- |
| **12-Factor Agents** | Use it when you want production-agent design principles to guide a hand-rolled or thinly-framed agent. | "?" (2/5) | [→](12-factor-agents.md) |
...
| --- | --- | --- | --- |
| [12-Factor Agents](12-factor-agents.md) | ✅ | "?" (2/5) | Use it when you want production-agent design principles to guide a hand-rolled or thinly-framed agent. |
