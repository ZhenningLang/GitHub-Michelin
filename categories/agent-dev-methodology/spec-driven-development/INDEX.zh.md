...
| 项目 | 何时用 | 健康度 | 页面 |
| --- | --- | --- | --- |
| **12-Factor Agents** | 当你想用一套生产级 agent 设计原则来指导手写或薄框架 agent 时使用。 | "?"（2/5） | [→](12-factor-agents.zh.md) |
...
| 选项 | 是否收录 | 健康度 | 一句话取舍 |
| --- | --- | --- | --- |
| [12-Factor Agents](12-factor-agents.zh.md) | ✅ | "?"（2/5） | 当你想用一套生产级 agent 设计原则来指导手写或薄框架 agent 时使用。 |
