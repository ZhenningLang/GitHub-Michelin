...
> Category node. Installable command/skill/agent bundles that bolt a ready-made SDLC layer onto an existing coding agent.
...
Distributions you install into a host coding agent (Claude Code, Codex, Cursor…) — slash commands, skills, subagents, hooks, memory. Not the underlying runtime (see `agent-frameworks`).
