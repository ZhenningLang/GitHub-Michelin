...
| **Claude Code Security Review** | Use it when you want LLM-driven, context-aware security review on trusted PRs via a GitHub Action. | B (4/6) | [→](claude-code-security-review.md) |
...
| **PR-Agent** | 🚀 PR Agent: The Original Open-Source PR Reviewer.  This project It is not the Qodo free tier. | A (5/6) | [→](pr-agent.md) |
| **Metis** | Metis is an open-source, AI-driven tool for deep security code review | B (5/6) | [→](metis.md) |
| **OpenReview** | An open-source, self-hosted AI code review bot powered by Vercel. | D (5/6) | [→](openreview.md) |
...
| [Claude Code Security Review](claude-code-security-review.md) | ✅ | B (4/6) | Use it when you want LLM-driven, context-aware security review on trusted PRs via a GitHub Action. |
