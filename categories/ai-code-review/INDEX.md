...
| **React Doctor** | Use it when a coding agent writes React and you want deterministic, repeatable checks for React-specific anti-patterns. | B (6/6) | [→](react-doctor.md) |
...
| **OpenReview** | An open-source, self-hosted AI code review bot powered by Vercel. | D (4/6) | [→](openreview.md) |
...
| [React Doctor](react-doctor.md) | ✅ | B (6/6) | Use it when a coding agent writes React and you want deterministic, repeatable checks for React-specific anti-patterns. |
