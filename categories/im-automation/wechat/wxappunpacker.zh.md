...
health:
  schema: 1
  computed_at: 2026-07-03T14:42:21Z
  overall: E
  overall_score: 0.0
  scored_axes: 4
  capped: true
...
| 替代品 | 是否收录 | 我们的评价 | 取舍 |
|---|---|---|---|
| qwerty472123/wxappUnpacker（上游） | 未收录 | 原始血缘和更完整的归档代码更重要时，选上游。 | 原始血缘，比这个被清空的 fork 完整，但**自 2020 起 archived/只读**——同样没人维护，只是没被删。 |
