...
| **wxappUnpacker** | 当你需要把自有的微信小程序 .wxapkg 包反编译回可读源码时用它——但本仓库已被清空成墓碑，请改用仍存活的 fork。 | E（3/6） | [→](wxappunpacker.zh.md) |
...
| [wxappUnpacker](wxappunpacker.zh.md) | ✅ | E（3/6） | 当你需要把自有的微信小程序 .wxapkg 包反编译回可读源码时用它——但本仓库已被清空成墓碑，请改用仍存活的 fork。 |
