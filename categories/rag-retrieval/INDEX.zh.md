...
| **Understand-Anything** | 当你想把任意代码库变成可探索、可提问的知识图谱给 agent 用时用它——比 graphify 更年轻、未经检验。 | B（5/6） | [→](understand-anything.zh.md) |
...
| **Milvus** | Milvus is a high-performance, cloud-native vector database built for scalable vector ANN search | A（4/6） | [→](milvus.zh.md) |
| **Sourcegraph** | Code AI platform with Code Search & Cody | E（3/6） | [→](sourcegraph.zh.md) |
...
| [Understand-Anything](understand-anything.zh.md) | ✅ | B（5/6） | 把代码变成 agent 可查询的可探索知识图谱；比 graphify 年轻，star 数与数据外发边界均存疑。 |
