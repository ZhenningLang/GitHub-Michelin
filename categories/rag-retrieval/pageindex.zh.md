...
health:
  schema: 1
  computed_at: 2026-09-22T16:57:54Z
  overall: B
  overall_score: 2.5
  scored_axes: 6
  applicable_axes: 6
...
- **响应速度**：Grade C——中位首次响应时间 558.2 小时，基于 7 个 qualifying issues/PRs。
...
- **采用 / 生态——小众但真实。** 能嵌入 agent 栈（OpenAI Agents SDK 示例），经 LiteLLM 支持多家提供方；“无向量 RAG”的提法有可见的心智占有。MIT 许可证，未观察到 relicense——但在假定某能力在仓库里之前，先核实开源与托管的边界。
