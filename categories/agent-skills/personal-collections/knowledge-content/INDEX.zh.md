...
| 合集 | 何时用 | 健康度 | 页面 |
| --- | --- | --- | --- |
| **dbskill** | 一套个人精选的中文 agent skill，聚焦商业模式诊断、内容创作与个人决策。 | C（3/6） | [→](dbskill.zh.md) |
| **Khazix Skills** | 一个小型中文个人合集，覆盖磁盘清理、AI 资讯查询、文档／记忆同步、长文研究报告和公众号风格写作。 | B（4/6） | [→](khazix-skills.zh.md) |
...
| 选项 | 是否收录 | 健康度 | 一句话取舍 |
| --- | --- | --- | --- |
| [dbskill](dbskill.zh.md) | ✅ | C（3/6） | 宽泛中文商业／内容／个人决策包；非商业许可限制复用。 |
| [Khazix Skills](khazix-skills.zh.md) | ✅ | B（4/6） | 更小的中文实用／研究／写作集合，边界更清楚。 |
