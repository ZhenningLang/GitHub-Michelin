...
| **no-ai-slop** | 英文编辑 skill：第一条规则就是保留作者本人的声音；按 20 多种具名 AI 模式做最小有效修改，带 eval.md 自检闭环，detect 模式只引用证据、不猜作者身份。 | C（4/6） | [→](no-ai-slop.zh.md) |
...
| [Baoyu Skills](../content-production/baoyu-skills.zh.md) | ✅ | B（4/6） | 更宽的中文内容 / 发布套件；Humanizer-zh 更窄，聚焦去 AI 味改写。 |
...
| [no-ai-slop](no-ai-slop.zh.md) | ✅ | C（4/6） | 声音保留优先的编辑 skill，detect 模式引用证据；稿子改完还得像作者本人时选它。 |
