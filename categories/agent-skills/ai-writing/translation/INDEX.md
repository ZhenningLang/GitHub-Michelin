...
> Leaf of [ai-writing](../INDEX.md). Whole-document and whole-book translation skills — file pipelines that turn PDF/DOCX/EPUB into another language through a coding agent.
...
| --- | --- | --- | --- |
| **translate-book** | Agent skill (Codex/Claude Code/OpenClaw) that translates entire books (PDF/DOCX/EPUB) with parallel subagents, glossary pinning, and neighbor-context consistency. | B (4/5) | [→](translate-book.md) |
...
| --- | --- | --- | --- |
| [translate-book](translate-book.md) | ✅ | B (4/5) | Whole-book translation as an agent skill: parallel subagents, glossary, resume, multi-format output — but young, single-maintainer, and Calibre/Pandoc-bound. |
