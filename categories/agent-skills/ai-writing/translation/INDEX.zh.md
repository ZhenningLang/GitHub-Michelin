...
| 合集 | 何时用 | 健康度 | 页面 |
| --- | --- | --- | --- |
| **translate-book** | 面向 Codex／Claude Code／OpenClaw 的 agent skill：并行 subagent 翻译整本书（PDF/DOCX/EPUB），带术语表钉定和相邻上下文一致性机制。 | B（4/5） | [→](translate-book.zh.md) |
...
| 选项 | 是否收录 | 健康度 | 一句话取舍 |
| --- | --- | --- | --- |
| [translate-book](translate-book.zh.md) | ✅ | B（4/5） | 整书翻译的 agent skill 形态：并行 subagent、术语表、断点续跑、多格式输出——但项目年轻、单人维护、绑死 Calibre／Pandoc。 |
