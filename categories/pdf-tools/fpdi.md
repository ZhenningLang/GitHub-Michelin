...
- **Adoption:** Grade A — the scorer recorded 5,723 dependent repositories and volume tier A. Its raw field is `downloads_last_month=171288629`; Packagist's direct stats endpoint instead reported 6,244,768 monthly and 171,313,863 total downloads on 2026-09-22, so the field-name mismatch needs tooling review.
