...
| 项目 | 何时用 | 健康度 | 页面 |
| --- | --- | --- | --- |
| **boilerpipe** | 一个用于从 HTML 做样板移除和全文抽取的 Java 库——经典的、算法驱动的路子（浅层文本特征、链接密度、标签比率），把文章抽出来、丢掉导航、广告和周边杂物。 | "?"（2/6） | [→](boilerpipe.zh.md) |
...
| **trafilatura** | Python & Command-line tool to gather text and metadata on the Web: Crawling, scraping, extraction, output as CSV, JSON, HTML, MD, TXT, XML | A（6/6） | [→](trafilatura.zh.md) |
