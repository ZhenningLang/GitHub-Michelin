...
| **TensorRT-LLM** | 当你需要在 NVIDIA GPU 上榨取最大 LLM 推理吞吐、并愿意接受仅限 NVIDIA 的绑定、复杂的构建/engine 编译流程以及闭源内核时用它。 | B（4/6） | [→](tensorrt-llm.zh.md) |
...
| [TensorRT-LLM](tensorrt-llm.zh.md) | ✅ | B（4/6） | NVIDIA 上的最高吞吐，代价是厂商绑定、engine 编译步骤与闭源内核。 |
