...
| [SGLang](sglang.zh.md) | ✅ | 需要 Python 原生结构化生成和 RadixAttention 前缀缓存时，选 SGLang。 | 高吞吐服务引擎，带 RadixAttention 前缀缓存和结构化生成优化；比 vLLM 更新、生态更小，不是跨厂商编译器平台。 |
...
- **响应速度**：Grade B——中位首次响应时间 55.1 小时，基于 18 个 qualifying issues/PRs。
