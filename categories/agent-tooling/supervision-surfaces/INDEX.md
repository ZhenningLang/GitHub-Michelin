...
| --- | --- | --- | --- |
| [Agent Orchestrator](agent-orchestrator.md) | ✅ | B (5/6) | A desktop control plane that fans work out to many agents in worktrees and routes CI/review feedback back — breadth over one artifact. |
...
| [CloudCLI (Claude Code UI)](claudecodeui.md) | ✅ | C (5/6) | Operate sessions from a browser or phone (files, terminal, git) — steering, not review. |
