...
| **CCPM** | Use it when a feature is too big for one session and you want PRD-to-GitHub-Issues specs plus parallel git-worktree agents. | C (4/5) | [→](ccpm.md) |
...
| [CCPM](ccpm.md) | ✅ | C (4/5) | PRD → GitHub Issues plus parallel worktree agents; buys issue-tracker truth and fan-out at the cost of Git-native state. |
