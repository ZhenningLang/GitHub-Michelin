...
| **AgentSociety** | Tsinghua FIB-Lab's LLM-native social-science simulation platform with Ray distribution, experiment replay, and DuckDB tracing. | B (6/6) | [→](agentsociety.md) |
...
| [AgentSociety](agentsociety.md) | ✅ | B (6/6) | Research-grade replay/distribution for experiments; heavier stack, framework-only. |
