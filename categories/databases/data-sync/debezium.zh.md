...
| 替代品 | 是否收录 | 我们的评价 | 取舍 |
|---|---|---|---|
| [ClickHouse](../database-engines/clickhouse.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 Debezium 对照。 | Debezium 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
| [DBeaver](../database-clients/dbeaver.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 Debezium 对照。 | Debezium 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
| [DuckDB](../database-engines/duckdb.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 Debezium 对照。 | Debezium 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
| [elasticsearch-dsl-py](../database-clients/elasticsearch-dsl-py.zh.md) | ✅ | 当你需要本分类里已经收录、约束更明确的方案时，先用它和 Debezium 对照。 | Debezium 是从 intake backlog 新增的首版页面；现有页面的“不用场景”如果更贴近任务，应优先按现有页面选择。 |
