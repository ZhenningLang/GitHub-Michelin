...
health:
  schema: 1
  computed_at: 2026-09-22T16:05:30Z
  overall: A
  overall_score: 4.0
  scored_axes: 5
  applicable_axes: 6
...
- **响应速度**：Grade A——中位首次响应时间 5.2 小时，基于 24 个 qualifying issues/PRs。
- **采用广度**：无法计算——unknown。
- **长青度**：Grade A——仓库已创建 2537 天。
- **治理集中度**：Grade A——前三贡献者占比 26.6%（过去 12 个月内 178 位活跃维护者）。
