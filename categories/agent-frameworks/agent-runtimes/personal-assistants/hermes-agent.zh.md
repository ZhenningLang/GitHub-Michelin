...
| [CrewAI](../agent-sdks/crewai.zh.md) | ✅ | 多智能体编排框架。 | CrewAI 聚焦多智能体团队；Hermes 聚焦单智能体自我改进。 |
...
- **采用广度**：Grade A——pypi.org 上月下载量 142,147（包名：hermes-agent）。
- **长青度**：Grade C——仓库已创建 427 天。
- **治理集中度**：Grade B——前三贡献者占比 65.0%（过去 12 个月内 496 位活跃维护者）。
