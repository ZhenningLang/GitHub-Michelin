...
| **Octop** | Use it when a household or small team needs isolated agents on Feishu/WeCom with chats on your disk — not when you want finished office skills, and the LangGraph core is still a private wheel. | B (4/6) | [→](octop.md) |
...
| [Octop](octop.md) | ✅ | B (4/6) | TencentCloud's self-hosted multi-user assistant for Feishu/WeCom on one Python process; two months old, and the agent runtime is a PyPI wheel whose GitHub repo 404s. |
