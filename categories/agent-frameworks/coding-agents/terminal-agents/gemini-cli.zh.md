...
| [CC Switch](../orchestration-and-review/cc-switch.zh.md) | ✅ | 多编码智能体桌面管理器。 | CC Switch 可将 Gemini CLI 与其他智能体一并管理；两者互补而非竞争。 |
...
- **采用广度**：Grade B——npmjs.org 上月下载量 1,331,337（包名：@google/gemini-cli）。
- **长青度**：Grade C——仓库已创建 523 天。
- **治理集中度**：Grade A——前三贡献者占比 20.5%（过去 12 个月内 79 位活跃维护者）。
