...
| **AutoGPT** | 当你需要一个用于创建、部署和管理持续运行 AI 智能体以自动化复杂工作流的平台时用它——但它未声明许可，且自托管需要大量资源。 | A（4/6） | [→](autogpt.zh.md) |
...
| [AutoGPT](autogpt.zh.md) | ✅ | A（4/6） | 当你需要一个用于创建、部署和管理持续运行 AI 智能体以自动化复杂工作流的平台时用它——但它未声明许可，且自托管需要大量资源。 |
