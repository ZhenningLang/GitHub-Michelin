...
- **响应速度**：Grade A——中位首次响应时间 2.7 小时，基于 29 个 qualifying issues/PRs。
- **采用广度**：Grade B——npmjs.org 上月下载量 11,288（包名：@immich/cli）。
- **长青度**：Grade A——仓库已创建 1692 天。
- **治理集中度**：Grade A——前三贡献者占比 24.0%（过去 12 个月内 307 位活跃维护者）。
