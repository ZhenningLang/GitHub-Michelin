...
health:
  schema: 1
  computed_at: 2026-07-03T14:54:09Z
  overall: B
  overall_score: 3.17
  scored_axes: 6
  capped: false
...
|---|---|---|---|
| [llama.cpp](../llm-inference/llama-cpp.md) | ✅ | Choose llama.cpp when you need broad GGUF model/quantization support and ubiquitous reach. | Far broader model/quantization support (GGUF ecosystem) and ubiquitous reach, but more cross-platform build complexity and no single Google-blessed mobile SDK — you assemble more glue. |
