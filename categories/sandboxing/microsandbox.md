...
- **Adoption.** ~8.3k stars and ~56 contributors, 526,504 npm downloads last month, five first-party SDKs, plus an MCP server and an Agent Skills pack. The scorer's registry graph, however, reports 0 dependent repositories, so third-party production dependence is not yet evidenced there. [未验证]
