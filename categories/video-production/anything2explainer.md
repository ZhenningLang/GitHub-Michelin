...
health:
  schema: 1
  computed_at: 2026-09-22T17:08:21Z
  overall: C
  overall_score: 2.0
  scored_axes: 3
  applicable_axes: 5
...
- **You need your own visual identity.** The look is deliberately fixed (black canvas, star-field or dot-field backdrop, white line art + purple accents, 44px subtitles); for bespoke branding write [Remotion](remotion.md) components directly and skip the skill.
