...
health:
  schema: 1
  computed_at: 2026-09-23T03:06:50Z
  overall: A
  overall_score: 3.5
  scored_axes: 4
  applicable_axes: 6
  ...
  axes:
    ...
    adoption:
      ...
      raw:
        ...
        downloads_last_month: 390962
        graph_tier: C
        volume_tier: C
        cross_check_divergence: null
        release_downloads: 6259
        release_assets: 273
        release_tier: D
...
- **采用广度**：Grade C——npmjs.org 上月下载量 390,962（包名：n8n）。
- **长青度**：Grade A——仓库已创建 2650 天。
- **治理集中度**：Grade A——前三贡献者占比 12.1%（过去 12 个月内 197 位活跃维护者）。
