...
| **Gaia** | 当作只读参考研究「流水线即编译插件」设计时用它——仓库已归档废弃，绝不可用于新的生产部署。 | D（6/6） | [→](gaia.zh.md) |
...
| **n8n** | 当你需要一款可视化优先、内置 400 余种集成、原生支持 AI、且可自托管的工作流自动化平台时用它——但不适合亚秒级实时流处理，且许可并非完全无限制的开源。 | A（4/6） | [→](n8n.zh.md) |
| **Argo Workflows** | Workflow Engine for Kubernetes | A（6/6） | [→](argo-workflows.zh.md) |
