...
| **Maigret** | Use it to build a username dossier across 3000+ sites with ID extraction, recursive search, and HTML/PDF/XMind reports — the most actively maintained pick in this category. | B (6/6) | [→](maigret.md) |
...
| [Maigret](maigret.md) | ✅ | B (6/6) | Deepest username dossiers (3000+ sites, ID extraction, recursion, reports), but a heavy dependency surface and slow full scans. |
