...
health:
  schema: 1
  computed_at: 2026-09-22T16:10:53Z
  overall: A
  overall_score: 3.83
  scored_axes: 6
  applicable_axes: 6
  ...
  axes:
    ...
    adoption:
      ...
      raw:
        ...
        downloads_last_month: 31950151
        graph_tier: B
        volume_tier: A
        cross_check_divergence: 2.62
        release_downloads: 162908
        release_assets: 165
        release_tier: C
...
- **响应速度**：Grade A——中位首次响应时间 5.1 小时，基于 39 个 qualifying issues/PRs。
- **采用广度**：无法计算——unknown。
- **长青度**：Grade A——仓库已创建 2628 天。
- **治理集中度**：Grade B——前三贡献者占比 84.6%（过去 12 个月内 16 位活跃维护者）。
