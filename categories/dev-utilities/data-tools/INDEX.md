...
| **CyberChef** | Use it when you need to chain encode/decode, crypto, compression and data-analysis transforms offline in your browser. | B (5/6) | [→](cyberchef.md) |
| **OpenZL** | Use it when you must squeeze terabytes of one highly structured/numeric format better than generic zstd. | B (5/6) | [→](openzl.md) |
...
| **ripgrep** | Use it when you need a fast, smart, cross-platform search tool that respects gitignore by default and works identically on Windows, macOS, and Linux. | B (6/6) | [→](ripgrep.md) |
| **fzf** | :cherry_blossom: A command-line fuzzy finder | B (6/6) | [→](fzf.md) |
| **jq** | Command-line JSON processor | B (5/6) | [→](jq.md) |
...
| [CyberChef](cyberchef.md) | ✅ | B (5/6) | Use it when you need to chain encode/decode, crypto, compression and data-analysis transforms offline in your browser. |
| [OpenZL](openzl.md) | ✅ | B (5/6) | Use it when you must squeeze terabytes of one highly structured/numeric format better than generic zstd. |
...
| [ripgrep](ripgrep.md) | ✅ | B (6/6) | Use it when you need a fast, smart, cross-platform search tool that respects gitignore by default and works identically on Windows, macOS, and Linux. |
