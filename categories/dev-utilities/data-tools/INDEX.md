...
| --- | --- | --- | --- |
| **DevToys** | Use it when you want offline, local-only dev utilities (Base64/JSON/hash/diff) in one cross-platform desktop app instead of untrusted online tools. | B (5/6) | [→](devtoys.md) |
...
| **fzf** | :cherry_blossom: A command-line fuzzy finder | A (6/6) | [→](fzf.md) |
| **jq** | Command-line JSON processor | A (5/6) | [→](jq.md) |
...
| --- | --- | --- | --- |
| [DevToys](devtoys.md) | ✅ | B (5/6) | Use it when you want offline, local-only dev utilities (Base64/JSON/hash/diff) in one cross-platform desktop app instead of untrusted online tools. |
