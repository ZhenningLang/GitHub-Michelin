...
> 分类节点。离线数据转换、压缩、测试数据、字体处理、进度提示与高速搜索工具。
...
| **CyberChef** | 当你需要在浏览器里离线串联编解码、加解密、压缩和数据分析变换、且数据不能外发时用它。 | B（5/6） | [→](cyberchef.zh.md) |
| **OpenZL** | 当你要把 TB 级的某种高度结构化/数值格式压得比通用 zstd 更狠时使用。 | B（4/6） | [→](openzl.zh.md) |
| **tqdm** | 当你想给 Python 循环/CLI/notebook 加一个快速、低开销的进度条时用它。 | B（4/6） | [→](tqdm.zh.md) |
...
| **fzf** | :cherry_blossom: A command-line fuzzy finder | B（6/6） | [→](fzf.zh.md) |
| **jq** | Command-line JSON processor | B（5/6） | [→](jq.zh.md) |
...
| [CyberChef](cyberchef.zh.md) | ✅ | B（5/6） | 当你需要在浏览器里离线串联编解码、加解密、压缩和数据分析变换、且数据不能外发时用它。 |
| [OpenZL](openzl.zh.md) | ✅ | B（4/6） | 当你要把 TB 级的某种高度结构化/数值格式压得比通用 zstd 更狠时使用。 |
| [tqdm](tqdm.zh.md) | ✅ | B（4/6） | 当你想给 Python 循环/CLI/notebook 加一个快速、低开销的进度条时用它。 |
...
离线数据转换、压缩、测试数据、字体处理、进度提示与高速搜索工具。
