...
- **响应速度**：Grade A——中位首次响应时间 0.0 小时，基于 12 个 qualifying issues/PRs。
- **采用广度**：Grade B——pypi.org 上月下载量 1,340,107（包名：open-webui）。
- **长青度**：Grade B——仓库已创建 1082 天。
- **治理集中度**：Grade C——前三贡献者占比 86.5%（过去 12 个月内 144 位活跃维护者）。
- **许可风险**：无法计算——unknown。
## 存疑（未验证）
