...
| --- | --- | --- | --- |
| **Functionary** | Use it only as the historical reference for open JSON-Schema function calling — it is deprecated; for production serve a current model or go on-device. | B (3/6) | [→](functionary.md) |
...
| --- | --- | --- | --- |
| [Functionary](functionary.md) | ✅ | B (3/6) | The canonical early open function-calling model (JSON-Schema tools, vLLM/SGLang serving) — now deprecated; pattern source only. |
