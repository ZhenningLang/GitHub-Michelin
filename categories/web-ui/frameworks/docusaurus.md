...
- **Adoption and ecosystem — very large for a docs framework, and corroborated by distribution.** The scorer resolves adoption to an npm package with **14,304 dependent repositories and 6,638,380 monthly downloads**; the repository shows ~66.3k stars and ~10.0k forks, adopters ranging from small projects to large vendor documentation sites, plus a plugin ecosystem and community swizzle patterns. Stars are attention, but here the attention is corroborated by a decade of releases.
