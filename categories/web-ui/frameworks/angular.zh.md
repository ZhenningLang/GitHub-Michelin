...
- **响应速度**：Grade A——中位首次响应时间 0.0 小时，基于 28 个 qualifying issues/PRs。
- **采用广度**：Grade A——npmjs.org 上月下载量 20,872,075（包名：@angular/core）。
- **长青度**：Grade A——仓库已创建 4387 天。
- **治理集中度**：Grade A——前三贡献者占比 36.0%（过去 12 个月内 89 位活跃维护者）。
