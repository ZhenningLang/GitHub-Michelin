...
|---|---|---|---|
| [Angular](../frameworks/angular.md) | ✅ | When you need the established in-index option for this category, compare it against Radix UI Primitives before switching. | Radix UI Primitives is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Radix UI Primitives only after verifying the repo-specific caveats below. |
...
| [Driver.js](../product-tours/driver-js.md) | ✅ | When you need the established in-index option for this category, compare it against Radix UI Primitives before switching. | Radix UI Primitives is newly indexed from the intake backlog; use the existing page when its documented constraints match better, and choose Radix UI Primitives only after verifying the repo-specific caveats below. |
