...
> Category node. UI component libraries, primitives, and design-system building blocks.
...
| --- | --- | --- | --- |
| **Ant Design** | An enterprise-class UI design language and React UI library. One of the most widely adopted component libraries for building admin dashboards, data-dense applications, and enterprise tools in the React ecosystem. | A (6/6) | [→](ant-design.md) |
| **Chakra UI** | Chakra UI is a component system for building SaaS products with speed ⚡️ | A (6/6) | [→](chakra-ui.md) |
...
UI component libraries, primitives, and design-system building blocks.
